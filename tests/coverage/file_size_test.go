...
func TestGovernedSourcePathExemptions(t *testing.T) {
	...
	tests := []struct {
		...
		{path: "render/templates/report.html", governed: true},
		{path: "render/templates/report.html.tmpl", governed: true},
		{path: ".specify/extensions/git/scripts/powershell/create-new-feature.ps1", governed: true},
